...
public class SmoothConfig {
    ...
    public static Screen configScreen(Screen parent) {
        return YetAnotherConfigLib.create(CONFIG, ((defaults, config, builder) -> builder
                .title(Text.translatable("key.smooth-skies.smooth-skies"))
                .category(ConfigCategory.createBuilder()
                        .name(Text.translatable("key.smooth-skies.smooth-skies"))
                        .option(Option.createBuilder(int.class)
                                .name(Text.translatable("key.smooth-skies.set-fog-view-distance"))
                                .description(OptionDescription.of(Text.translatable("key.smooth-skies.set-fog-view-distance.description")))
                        ...
                        .option(Option.createBuilder(boolean.class)
                                .name(Text.translatable("key.smooth-skies.lower-sky-void-darkness"))
                                .description(OptionDescription.of(Text.translatable("key.smooth-skies.lower-sky-void-darkness.description")))
                                .binding(defaults.lowerSkyVoidDarkness, () -> config.lowerSkyVoidDarkness, newVal -> config.lowerSkyVoidDarkness = newVal)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.createBuilder(boolean.class)
                                .name(Text.translatable("key.smooth-skies.clear-skies"))
                                .description(OptionDescription.of(Text.translatable("key.smooth-skies.clear-skies.description")))
