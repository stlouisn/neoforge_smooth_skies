...
public class Config {
  ...
  public static Screen configScreen(Screen parent) {
    return YetAnotherConfigLib.create(CONFIG,
                                      ((defaults, config, builder) -> builder.title(Text.translatable("smooth-skies.smooth-skies"))
                                                                             .category(ConfigCategory.createBuilder()
                                                                                                     ...
                                                                                                     .option(Option.<Integer>createBuilder()
                                                                                                                   ...
                                                                                                                   .controller(opt -> IntegerSliderControllerBuilder.create(opt).range(0, 550).step(1))
                                                                                                                   .build())
